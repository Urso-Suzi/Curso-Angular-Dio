...
const valorDinheiro = parseFloat(prompt());
const moedaOrigem = prompt();
const moedaDestino = prompt();
...
//TODO: Crie uma estrutura condicional que realize a conversão das moedas:
  ...
  let valorConvertido2 = valorConvertido.toFixed(2)

//TODO: Imprima a conversão com duas casas decimais:
  console.log(`${valorDinheiro} ${moedaOrigem} equivalem a ${valorConvertido2} ${moedaDestino}.`);
}